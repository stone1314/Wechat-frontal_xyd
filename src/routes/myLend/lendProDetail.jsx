...
import lpdStyle from './lendProDetail.less'
...
class LendPro extends React.Component{
    constructor(props){
        ...
        this.state = {
            ...
            lendProObj:window.localStorage.getItem("lendProObj"),
        }
    }
    /**
     *  返回
        ...
        if(!lpObj){
            return(
                <div className={lpdStyle.lendList}>
                    <div className={lpdStyle.backBar}>
                        <img className={lpdStyle.backImg} src={backImg} onClick={this.backToPage.bind(this)}/>
                        <div className={lpdStyle.backImgText} onClick={this.backToPage.bind(this)}>返回</div>
                        <div className={lpdStyle.backTitle}>债权详情</div>
                        <div className={lpdStyle.backPro}>协议</div>
                    </div>
        ...
        return(
            <div className={lpdStyle.lendList}>
                ...
                <div className={lpdStyle.lendProBody}>
                    ...
                    <div className={lpdStyle.lendTable}>
                        <div className={lpdStyle.lendHead}>贷后信息</div>
                        <div className={lpdStyle.lendBody}>
                            <div className={lpdStyle.lendBodyKey}>资金运用情况</div>
                            <div className={lpdStyle.lendBodyValue}>{lpObj.app_of_loan_amt}</div>
                        </div>
                        <div className={lpdStyle.lendBody}>
                            <div className={lpdStyle.lendBodyKey}>精英状况及财务状况</div>
                            <div className={lpdStyle.lendBodyValue}>{lpObj.bus_fin_of_loan_person}</div>
                        </div>
                        <div className={lpdStyle.lendBody}>
                            <div className={lpdStyle.lendBodyKey}>还款能力变化情况</div>
                            <div className={lpdStyle.lendBodyValue}>{lpObj.payable_of_loan_person}</div>
                        </div>
                        <div className={lpdStyle.lendBody}>
                            <div className={lpdStyle.lendBodyKey}>逾期情况</div>
                            <div className={lpdStyle.lendBodyValue}>{lpObj.duecounts_of_loan_person}</div>
                        </div>
                        {lpObj.duecounts_of_loan_person == "逾期"?<div className={lpdStyle.lendBody}>
                            <div className={lpdStyle.lendBodyKey}>还款保障措施</div>
                            <div className={lpdStyle.lendBodyValue}>{lpObj.loan_credit_incr_org}</div>
                        ...
                        <div className={lpdStyle.lendBody}>
                            <div className={lpdStyle.lendBodyKey}>涉诉情况</div>
                            <div className={lpdStyle.lendBodyValue}>{lpObj.lawsuit_of_loan_person}</div>
                        </div>
                        <div className={lpdStyle.lendBody}>
                            <div className={lpdStyle.lendBodyKey}>行政处罚情况</div>
                            <div className={lpdStyle.lendBodyValue}>{lpObj.penalty_of_loan_person}</div>
                        </div>
                    </div>
                </div>
                <ModalInfo
